...
$query = "SELECT * FROM plants WHERE category='bonsai' ";
...
<html lang="en">
  ...
  <br>
		  <center><h2><u>Top Picks for Products</u></h2></center>
	<br>
   <br><br>-->
   ...
   <div class="container main">
		  ...
		  <br>
		  <center><h2 style="margin-bottom:40px;font-size: 28px;">Bonsai</h2></center><br><br>
          <div class="row">
          <?php  
