...
$sql = "SELECT * FROM fertilizer ORDER BY id DESC LIMIT {$offset}, {$limit}";
  ...
  <br>
   ...
   <br><br>-->
  	...
  	<div class="container main">
		  ...
		  <br>
		  <center><h2 style="margin:2% 0;font-size: 28px;">All Fertilizers</h2></center><br>
          <div class="row">
          <?php  
  			...
  			<div class="col-md-3 col-sm-5">
  				<div class="product-grid">
  					<div class="product-image">
                          ...
                          <ul class="social">
  							<li><a href="Fertilizer_Product.php?myid=<?php echo $post_id; ?>"  data-tip="Quick View"> <i class="fa fa-search"></i></a></li>
  					...
  					<div class="product-content">
  						<h3 class="title"><a href="Fertilizer_Product.php?myid=<?php echo $post_id; ?>"><?php echo $post_name;?></a></h3>
  						<div class="price"><?php echo "$post_price"?>  ₹<span><?php echo $post_del_price ?>₹</span></div>
						 
  						<a class="add-to-cart" href="Fertilizer_Product.php?myid=<?php echo $post_id; ?>">view item</a>
  					</div>
