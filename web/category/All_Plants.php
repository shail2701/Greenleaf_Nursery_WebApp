...
$sql = "SELECT * FROM plants ORDER BY id DESC LIMIT {$offset}, {$limit}";
  ...
  <br>
   ...
   <br><br>-->
  	...
  	<div class="container main">
		  ...
		  <br>
		  <center><h2 style="margin:2% 0;font-size: 28px;">All Plants</h2></center><br>
          <div class="row">
          <?php  
...
echo '<li class="'.$active.'"><a href="All_Plants.php?page='.$i.'">'.$i.'</a></li></div>';
