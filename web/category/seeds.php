...
<?php
      ...
      if(isset($_GET['delcid']))
      {
          ...
          if($del_com)
          {
            ...
            header("location:seeds.php?myid=$item_id");
          }
          else
          {
      ...
      $query = "SELECT * FROM seeds  WHERE id = $item_id";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
      <link rel="stylesheet" href="pThep12.css">
...
<!-- <div class="card-body"> -->
  <div class="container">
      ...
      <div class="row m-0">
        <div class="col-lg-12">
        <p class="path-r"><span class="backme" onclick="goBack()"><i class="fa fa-arrow-left" aria-hidden="true"> Go Back </i> </span><a href="All_Seeds.php">Seeds</a> > <a href="<?php echo $cat_name?>.php"><?php echo $cat_name; ?></a> > <?php echo "<span style='font-size:80%;'>".$post_name."</span>"; ?> </p>
      </div>	
        ...
        if (isset($_POST['qty14'])) {
            ...
            $query_1 = "INSERT INTO shoppingcart(id,name,price,image,quantity,uid) VALUE ($post_id,'$post_name',$post_price,'$post_image',$qtys_1,$uid)";
               ...
               if (mysqli_query($conn, $query_1)) {
                echo "<br><span class='prod-quanty'>Quantity : ".$qtys_1." Added</span>";
                    $sucess=true;
...
<hr>
  <div class="container" style="padding:2%;">
     <div class="descr"  style=""> 
      ...
      <div class="descr" style=""> 
       <h3 style="">Fetures</h3>
       <p><h6 style=""><?php echo nl2br($post_fetures); ?></h6></p>
      
       </div>    

 
    <div class="abot"> 
      <p><h3 style="">About Care </h3></p>
          <ul>
            <li style=""><h6><?php echo nl2br($post_care); ?></h6></li>
            
          </ul>
    </div>

    <div class="pro-fet" > 
      <h3 style="">About Use</h3>
      <p><h6 style="">- <?php echo nl2br($post_use); ?></h6></p>
...
<div class="well comm">
            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <h6 style="color:red;">* Abuse comment remove by admin..</h6><br><br>
              ...
              <div class="media">
                     ...
                     <div class="media-body">
                        ...
                        <?php if(isset($_SESSION['id'])) { if($comment_uid==$_SESSION['id']) {?>
                           ...
                           <a style="color:black;" href="seeds.php?myid=<?php echo $item_id;?>&delcid=<?php echo $comment_uid; ?>&delcdt=<?php echo $comment_date;?>">delete</a>
