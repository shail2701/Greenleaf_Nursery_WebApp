...
global $item_id;
      ...
      if(isset($_GET['delcid']))
      {
          ...
          if($del_com)
          {
            ...
            header("location:product.php?myid=$item_id");
          }
          else
          {
      ...
      $query = "SELECT * FROM plants WHERE id = $item_id";
...
<!-- <div class="card-body"> -->
  <div class="container">
      ...
      <div class="row m-0">
        <div class="col-lg-12">
      <p class="path-r"><span class="backme" onclick="goBack()"><i class="fa fa-arrow-left" aria-hidden="true"> Go Back </i> </span><a href="All_Plants.php">Plants</a> > <a href="<?php echo $cat_name?>.php"><?php echo $cat_name; ?></a> > <?php echo "<span style='font-size:80%;'>".$post_name."</span>"; ?> </p>
      </div>	
                ...
                <div class="media">
                     ...
                     <div class="media-body">
                        ...
                        <?php if(isset($_SESSION['id'])) { if($comment_uid==$_SESSION['id']) {?>
                             ...
                             <a style="color:black;" href="product.php?myid=<?php echo $item_id;?>&delcid=<?php echo $comment_uid; ?>&delcdt=<?php echo $comment_date;?>">delete</a>
