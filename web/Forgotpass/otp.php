...
if(!strcmp($rno,$urno))
{
    ...
    $headers = "From: greenleaf.bhavani@gmail.com" . "\r\n" .
    "CC: darshilpatel4393@gmail.com";
...
{
    $message="Sucessfully send OTP to your mail";
    $rno=$_SESSION['otp'];
    $to=$_SESSION['email'];
    ...
    $txt = "Resending Forgot Password OTP: ".$rno."";
    // $headers = "From: greenleaf.bhavani@gmail.com" . "\r\n";
	...
	$headers  = 'MIME-Version: 1.0' . "\r\n";
                    ...
                    ">
                      ...
                      $message .= '<tr class="noo" style="border: 5px solid #9aff39;background-color: white;color:tomato;
                      font-size: 15px;color: black;padding: 3% 19%;font-weight: 500;text-align: left;border-radius: 10px;-webkit-box-shadow: 0 0px 20px 6px #0a0a0a70;"><p style="color: tomato;">'.$bodyy.'</p></tr>';
                      ...
                      text-align: center;
                      border-radius: 10px;
                      -webkit-box-shadow: 0px 0px 20px 4px #9aff39f2;">'.$txt.'</tr></p><tr><span style="padding: 2% 38%;
    ...
    $message="Sucessfully resend OTP to your mail";
}
?>
<!DOCTYPE html>
<html>
    ...
    <div class="overlay-container">
        ...
        <form action="" method="post" class="signup">
                ...
                <hr style="border: 2px solid #676767;width: 100%;background-color: #676767;border-radius: 24px;">
     		    ...
     		    <span class="err" ><?php echo $message; ?></span>
     	        <?php } ?> 
                ...
                <input type="text" name="otpvalue" placeholder="Enter OTP Here.." />
                
				<button name="save">Done</button>
                <br>
