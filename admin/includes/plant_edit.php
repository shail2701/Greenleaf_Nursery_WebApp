...
$select_post = mysqli_query($conn,$query);
      ...
      if($post_image_temp!="") {
         ...
         echo "moved success ".$post_image;
               ...
               {
                     $query = "UPDATE plants SET category = '{$post_category}',name = '{$post_name}',image = '{$post_image}',price = '{$post_price}',del_price = '{$post_del_price}',description = '{$post_description}',care = '{$post_care}',fetures = '{$post_fetures}', uses = '{$post_uses}' WHERE id = {$post_id}";
...
?> -->
      ...
      <div class="form-group">
          <input class="btn btn-primary" type="submit" name="update_plant" value="Upadate Plant">
      </div>
