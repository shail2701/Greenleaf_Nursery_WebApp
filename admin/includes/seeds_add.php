    ...
    if(isset($_POST['create_plant'])){
        ...
        if($post_image_temp!="") {
         ...
         echo "<br>moved success ".$post_image;
               ...
               {   
             $query = "INSERT INTO seeds(category, name,image,price,del_price,description,care,fetures,uses) VALUES('{$post_category}','{$post_name}','{$post_image}',{$post_price},{$post_del_price},'{$post_description}','{$post_care}','{$post_fetures}','{$post_uses}') ";
